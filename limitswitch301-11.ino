    ...
    case 1:  //Section 1 rotated CW to 120
      {
        ...
        if ((millis() - lastDebounceTime) > debounceDelay) {
          ...
          if (switch2state != switch2currentstate) {
            ...
            if ((switch2currentstate == HIGH) && (count == 1)) {            //If switch2 pressed -- S1 turned CW
              Serial.println("\nSwitch 2 Section 1");
              digitalWrite(CW, HIGH);
    ...
    case 2: //Section 1 turned CCW back to 0
      {
        ...
        if ((millis() - lastDebounceTime) > debounceDelay) {
          ...
          if (switch1state != switch1currentstate) {
            ...
            if ((switch1currentstate == HIGH) && (count == 2)) {  //If switch 1 pressed -- S1 turned CCW
              digitalWrite(CW, HIGH);
              digitalWrite(CCW, HIGH);
              ...
              if (pass == 9) {                    //If this is the fourth pass, skip to case 3
                count = 3;
                Serial.println("\nEnd of section 1");
                digitalWrite(CW, LOW);
                digitalWrite(CCW, HIGH);
    ...
    case 7:
      {
        ...
        if ((millis() - lastDebounceTime) > debounceDelay) {
          ...
          if (switch1state != switch1currentstate) {
            ...
            if (switch1currentstate == HIGH) {    // Deleted count == 7 condition (condition already checked by switch)

              Serial.println("count is 7");
              digitalWrite(CW, HIGH);
              digitalWrite(CCW, HIGH);
